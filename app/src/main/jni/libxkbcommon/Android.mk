...
LOCAL_CFLAGS := \
	...
	-D_GNU_SOURCE \
	-DXLOCALEDIR=\"/data/data/com.vectras.boxvidra/files/distro/share/X11/locale\" \
	-DDEFAULT_XKB_LAYOUT=\"us\" \
	-DDEFAULT_XKB_MODEL=\"pc105\" \
	-DDEFAULT_XKB_RULES=\"evdev\" \
	-DDFLT_XKB_CONFIG_ROOT=\"/data/data/com.vectras.boxvidra/files/distro/share/X11/xkb\"
