...
public class LorieService extends Service {
    ...
    static final String ACTION_STOP_SERVICE = "com.vectras.boxvidra.service_stop";
    static final String ACTION_START_FROM_ACTIVITY = "com.vectras.boxvidra.start_from_activity";
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.vectras.boxvidra.start_preferences_activity";
    static final String ACTION_PREFERENCES_CHAGED = "com.vectras.boxvidra.preferences_changed";
    ...
    private static X11Activity act;
    ...
    static void setX11Activity(X11Activity activity) {
        act = activity;
    }
    ...
    public void onCreate() {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), X11Activity.class);
        ...
        String channelId = Build.VERSION.SDK_INT >= O ? getNotificationChannel(notificationManager) : "";
