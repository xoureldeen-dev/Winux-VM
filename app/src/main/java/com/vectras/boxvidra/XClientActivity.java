...
import static com.vectras.boxvidra.CmdEntryPoint.ACTION_START;
import static com.vectras.boxvidra.LoriePreferences.ACTION_PREFERENCES_CHANGED;
...
import com.vectras.boxvidra.input.InputEventSender;
import com.vectras.boxvidra.input.InputStub;
import com.vectras.boxvidra.input.TouchInputHandler;
import com.vectras.boxvidra.utils.FullscreenWorkaround;
import com.vectras.boxvidra.utils.KeyInterceptor;
import com.vectras.boxvidra.utils.TermuxX11ExtraKeys;
import com.vectras.boxvidra.utils.X11ToolbarViewPager;
...
public class XClientActivity extends AppCompatActivity implements View.OnApplyWindowInsetsListener {
    static final String ACTION_STOP = "com.vectras.boxvidra.ACTION_STOP";
    ...
    private final BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_START.equals(intent.getAction())) {
                ...
                Log.d("XClientActivity", "preference: " + intent.getStringExtra("key"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!start(new String[]{"-ac", ":0"}))
            System.exit(1);

        new Terminal(instance).showVterm();
    }
    ...
    void initMouseAuxButtons() {
        ...
        pos.setOnTouchListener(new View.OnTouchListener() {
            final int touchSlop = (int) Math.pow(ViewConfiguration.get(XClientActivity.this).getScaledTouchSlop(), 2);
    ...
    void tryConnect() {
        ...
        try {
            ...
            if (fd != null) {
                Log.v("XClientActivity", "Extracting X connection socket.");
    ...
    void onPreferencesChanged(String key) {
        ...
        if (prefs.enableAccessibilityServiceAutomatically.get()) {
            try {
                Settings.Secure.putString(getContentResolver(), Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES, "com.vectras.boxvidra/.utils.KeyInterceptor");
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Android requires WRITE_SECURE_SETTINGS permission to start accessibility service automatically.\n" +
                                ...
                                "adb shell pm grant com.vectras.boxvidra android.permission.WRITE_SECURE_SETTINGS")
