...
import com.vectras.shared.termux.extrakeys.ExtraKeysView;
...
public class X11ToolbarViewPager {
    public static class PageAdapter extends PagerAdapter {
        ...
        final XClientActivity mActivity;
        private final View.OnKeyListener mEventListener;

        public PageAdapter(XClientActivity activity, View.OnKeyListener listen) {
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            if (position == 0) {
                ...
                editText.setOnCapturedPointerListener((v2, e2) -> {
                    XClientActivity.setCapturingEnabled(false);
                    return false;
                });
    ...
    public static class OnPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        final XClientActivity act;
        final ViewPager mTerminalToolbarViewPager;

        public OnPageChangeListener(XClientActivity activity, ViewPager viewPager) {
            this.act = activity;
