...
import static com.vectras.shared.termux.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
import static com.vectras.boxvidra.XClientActivity.toggleKeyboardVisibility;
...
import com.vectras.shared.termux.extrakeys.*;
...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    public TermuxX11ExtraKeys(@NonNull View.OnKeyListener eventlistener, XClientActivity activity, ExtraKeysView extrakeysview) {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.vectras.boxvidra.start_preferences_activity";
    ...
    public boolean performExtraKeyButtonHapticFeedback(View view, ExtraKeyButton buttonInfo, Button button) {
        XClientActivity.handler.postDelayed(() -> {
            boolean pressed;
    ...
    public static void setExtraKeys() {
        ...
        try {
            ...
            String extrakeys = XClientActivity.getPrefs().extra_keys_config.get();
            mExtraKeysInfo = new ExtraKeysInfo(extrakeys, "extra-keys-style", ExtraKeysConstants.CONTROL_CHARS_ALIASES);
        } catch (JSONException e) {
            Toast.makeText(XClientActivity.getInstance(), "Could not load and set the \"extra-keys\" property from the properties file: " + e, Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                Toast.makeText(XClientActivity.getInstance(), "Can't create default extra keys", Toast.LENGTH_LONG).show();
