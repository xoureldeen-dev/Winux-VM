...
public class LoriePreferences extends AppCompatActivity {
    static final String ACTION_PREFERENCES_CHANGED = "com.vectras.boxvidra.ACTION_PREFERENCES_CHANGED";
    ...
    public static class LoriePreferenceFragment extends PreferenceFragmentCompat implements OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            intent.setPackage("com.vectras.boxvidra");
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                if (intent.getExtras() != null) {
                    Prefs p = (XClientActivity.getInstance() != null) ? new Prefs(XClientActivity.getInstance()) : (prefs != null ? prefs : new Prefs(context));
                    ...
                    for (String key : intent.getExtras().keySet()) {
                        ...
                        intent0.setPackage("com.vectras.boxvidra");
