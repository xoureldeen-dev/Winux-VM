...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/com.vectras.boxvidra/files/home/.termux/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.vectras.boxvidra/files/home/.termux/colors.properties");
