...
class Globals
{
	...
	public static String[] DataDownloadUrl = { "!!Library mapping|bin-map.zip", "!!Data files|:data.tar.gz:data-2.tgz", "!!Data files|:DroidSansMono.ttf:DroidSansMono.ttf", "Additional fonts (90Mb)|:xfonts.tar.gz:https://sourceforge.net/projects/libsdl-android/files/apk/XServer-XSDL/xfonts.tgz/download",  };
	...
	public static String DeleteFilesOnUpgrade = "libsdl-DownloadFinished-0.flag libsdl-DownloadFinished-1.flag busybox usr tmp pulseaudio.conf";
	...
	public static boolean HideSystemMousePointer = true;
	...
	public static boolean KeepAspectRatio = true; //KeepAspectRatioDefaultSetting
